...
module.exports = {
  ...
  db: process.env.MONGODB|| 'mongodb://localhost:27017/Web',

  sessionSecret: process.env.SESSION_SECRET || 'weibu;sofgeguio;svsns',
  ...
  mandrill: {
    user: process.env.MANDRILL_USER || 'chatterjee.pra@gmail.com',
    password: process.env.MANDRILL_PASSWORD || 'IReZPLlpxGA4ojY2DUCOIA'
  },

  sendgrid: {
    user: process.env.SENDGRID_USER || 'pradyumnac',
    password: process.env.SENDGRID_PASSWORD || 'UoISEC9PE9Aymswe'
  },
  ...
  facebook: {
    clientID: process.env.FACEBOOK_ID || '1559582084276181',
    clientSecret: process.env.FACEBOOK_SECRET || '6d4e8d2625e27d8326aee65d8178bf7f',
  ...
  twitter: {
    consumerKey: process.env.TWITTER_KEY || 'j98Jc2nHmrYomR2MeHEFMNcFw',
    consumerSecret: process.env.TWITTER_SECRET  || '98THwxbiWSM6URsNtm8lBPAZkxKb8SX3ErfLdatTVOhmBHbUcM',
